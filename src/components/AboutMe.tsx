...
export default function AboutMe(){
    return(
        <div className="flex flex-row py-20 bg-slate-900 items-center justify-evenly" id="About">
            <div className="w-64">
