...
export default function InitialPage() {
    return(
        <div className="flex flex-col h-screen items-center justify-center" id="Home">
            ...
            <h2 className="text-xl mt-1 max-sm:text-lg">I am a computer science student</h2>

            <div className="flex flex-row mt-3 gap-x-2">
                <a href="https://github.com/reidakaimfz" className=""><FaGithub className="h-16 w-16 max-sm:h-12 max-sm:w-12"/></a>
                ...
                <a className="flex h-16 w-48 items-center justify-center bg-green-500 rounded-full ml-2  max-sm:h-12 max-sm:w-28" download={true} href={curriculum}>
